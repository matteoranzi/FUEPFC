...
public class GameController {
    ...
    void handleFirstCellMouseClicked() {
        if (tableStatus[0][0] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleSecondCellMouseClicked() {
        if (tableStatus[0][1] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleThirdCellMouseClicked() {
        if (tableStatus[0][2] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleFourthCellMouseClicked() {
        if (tableStatus[1][0] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleFifthCellMouseClicked() {
        if (tableStatus[1][1] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleSixthCellMouseClicked() {
        if (tableStatus[1][2] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleSeventhCellMouseClicked() {
        if (tableStatus[2][0] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleEighthCellMouseClicked() {
        if (tableStatus[2][1] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
    ...
    void handleNinthCellMouseClicked() {
        if (tableStatus[2][2] == CellStatus.BLANK) {
            if (isPlayer1Turn) {
